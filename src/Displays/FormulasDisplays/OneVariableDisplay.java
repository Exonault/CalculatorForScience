...
public class OneVariableDisplay {
	...
	// Predefinirane na text-fieldovete za chisloto i resultata
	...
	public static void factoriel() {
		...
		equal.addMouseListener(new MouseAdapter() {
			public void mouseClicked(MouseEvent arg0) {
				// Zadavane na promenliva B sas stoinost na text-fielda
